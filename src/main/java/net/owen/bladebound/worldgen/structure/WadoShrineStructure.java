...
public class WadoShrineStructure extends Structure {

    public static final MapCodec<WadoShrineStructure> CODEC =
            Structure.createCodec(WadoShrineStructure::new);

    public WadoShrineStructure(Config config) {
        super(config);
    }
    ...
    public StructureType<?> getType() {
        return BladeboundStructures.WADO_SHRINE;
    }
}
